...
class _JokenpoState extends State<Jokenpo> {
  ...
  Image rock = Image.asset('assets/images/rock.png', width: 200, height: 200);
  Image paper = Image.asset('assets/images/paper.png', width: 200, height: 200);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 20),
          Divider(color: Colors.white, indent: 60, endIndent: 60),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
